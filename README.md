...
恢复使用提示（终端，bundle id `app.flipview.viewer`）：
...
- **Later** / **Don’t Update** — dismiss this launch; ask about updates again next launch
...
Reset launch tips in Terminal (bundle id `app.flipview.viewer`):
